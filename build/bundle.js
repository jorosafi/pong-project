...
var Game = function () {
	function Game(element, width, height) {
		...
		this.ball = new _Ball2.default(8, this.width, this.height); //this is one of the changes from Jim's version
...
var game = new _Game2.default('game', 800, 400);
  ...
  _createClass(Ball, [{
    ...
    value: function paddleCollision(player1, player2) {
      ...
      if (this.vx > 0) {
        ...
        if (this.x - this.radius <= _rightX && // left edge of the ball is <= right edge of the paddle
        this.x - this.radius >= _leftX // left edge of the ball is >= left edge of the paddle
        && this.y >= _topY && this.y <= _bottomY // ball Y is >= paddle top Y or <= paddle bottom
        ) {
            this.vx = -this.vx;
            this.ping.play();
          }
